...
export type RunSessionMutation = { __typename?: 'Mutation', runSession: boolean };
...
export type RenderCompleteMutationVariables = Exact<{
  channelKey: Scalars['String']['input'];
  instructionId: Scalars['ID']['input'];
}>;


export type RenderCompleteMutation = { __typename?: 'Mutation', renderComplete: boolean };
